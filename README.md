...
- **Tracer** — Zero-dependency, lightweight Go + SQLite log aggregator, delivering a 90% cost reduction compared to heavy OpenTelemetry-based infrastructure.
...
Most of my public source code is hosted at [git.naqerl.com](https://git.naqerl.com) and [GitHub](https://github.com/naqerl).
