...
| Area         | Technologies |
|-------------|-------------|
| Languages    | Go, Python, Solidity, Guile Scheme |
| AI           | Genkit, LangChain, RAG, Multi-agent Systems, ClickHouse |
...
- **Tracer** — Zero-dependency log aggregator (Go + SQLite), 90% cost reduction vs OpenTelemetry
- **Cyberpass** — Touchless CRM for 12+ VR venues, 8K+ customers, 1.5+ years zero critical incidents
- **Lumicare** — AI skincare analysis with FastAPI/React, 70% token cost reduction
